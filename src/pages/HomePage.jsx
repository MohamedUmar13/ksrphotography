...
const stats = [
  ...
  { label: "Edited Frames", value: "50k+", icon: ImageIcon },
];
...
export default function HomePage() {
  ...
  return (
    ...
    >
      ...
      <Container maxWidth="xl" sx={{ mt: { xs: -6, md: -8 }, position: "relative", zIndex: 2 }}>
          ...
          {stats.map(({ icon: Icon, label, value }) => (
            <Grid item xs={6} md={3} key={label}>
              ...
              >
                ...
                <Typography sx={{ mt: 2, fontSize: { xs: "1.8rem", md: "2.2rem" }, fontWeight: 700 }}>
                  {value}
                </Typography>
                <Typography sx={{ mt: 0.5, color: "rgba(23,23,23,0.65)", letterSpacing: "0.08em" }}>
                  {label}
                </Typography>
              </Box>
            </Grid>
      ...
      <Container maxWidth="xl" sx={{ py: { xs: 10, md: 16 } }}>
        <Grid container spacing={{ xs: 6, md: 9 }} alignItems="center">
          ...
          <Grid item xs={12} md={6}>
            ...
            <Typography sx={{ color: "rgba(23,23,23,0.7)", lineHeight: 2, mb: 4 }}>
