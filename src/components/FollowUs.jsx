  ...
  return (
    <StyledWrapper>
      <div className="card">
        ...
        <div className="socialContainer containerOne" onClick={() => window.location.href = "https://www.instagram.com/ksr_photography__/"}>
        ...
        <div className="socialContainer containerTwo" onClick={() => window.location.href = "https://www.youtube.com/@KsrPhotography-"}>
        ...
        <div className="socialContainer containerFour" onClick={() => window.location.href = "https://wa.me/+919361055928"}>
